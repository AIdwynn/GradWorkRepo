...
namespace Vital.ObjectPools
{
        ...
        where T : MonoBehaviour
    {
        ...
        public event EventHandler<MonoBehaviourPoolGrewEventArgs<T>> PoolGrew;
        ...
        private T InstantiateOriginal()
        {
            ...
            SCR_EventHelper.TrySendEvent(PoolGrew, this, new MonoBehaviourPoolGrewEventArgs<T>( obj));
